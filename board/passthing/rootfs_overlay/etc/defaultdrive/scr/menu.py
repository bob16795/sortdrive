...
class Menu(object):
    ...
    def drawoverlay(self):
        ...
        self.window.addstr(0, maxx - (len(string)), string, curses.A_REVERSE)
    ...
    def display(self): 
        ...
        while True:
            ...
            self.window.addstr(0, 0, " "*(self.screen.getmaxyx()[1] - 1), curses.A_REVERSE)
